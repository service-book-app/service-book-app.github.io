...
<section>
    ...
    <h6>Expenses</h6>
    <p>Here, record all expenses related to the car: <span class="bold">spare parts, oil, coolant, new equipment, as well as services like car washes, insurance, technical inspections, fines, etc.</span> <span class="italic">Please do not duplicate amounts that have already been described in the "Repairs" section.</span></p>
    <h6>Repair</h6>
    <p>It is of great importance to accurately record all <span class="bold">repair activities, adjustments, replacements, and diagnostics</span> performed on your car. <span class="italic">Please request that this be done at the service center you use!</span></p>
</section>`;
